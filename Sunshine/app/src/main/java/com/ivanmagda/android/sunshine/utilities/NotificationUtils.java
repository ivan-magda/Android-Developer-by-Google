package com.ivanmagda.android.sunshine.utilities;
...
import com.ivanmagda.android.sunshine.R;
import com.ivanmagda.android.sunshine.activity.DetailActivity;
import com.ivanmagda.android.sunshine.data.SunshinePreferences;
import com.ivanmagda.android.sunshine.data.WeatherContract;
...
public class NotificationUtils {
    ...
    public static void notifyUserOfNewWeather(Context context) {
         ...
         * WeatherContract class and is used to limit the columns returned in our cursor.
         */
        ...
        if (todayWeatherCursor != null && todayWeatherCursor.moveToFirst()) {
            ...
            detailIntentForToday.putExtra(DetailActivity.EXTRA_WEATHER_URI, todaysWeatherUri);
